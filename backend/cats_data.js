const cats = [
  ...
  { cat_id: 'CAT089', name: '窄窄', area: '各学院', specific_location: '环院&四组团' },
  ...
  { cat_id: 'CAT094', name: '雪里拖枪', area: '各学院', specific_location: '计算机' },
  { cat_id: 'CAT095', name: '袖套', area: '宿舍区', specific_location: '四组团' },
  { cat_id: 'CAT096', name: '领结猫', area: '公共区域', specific_location: '图书馆、一组团' },
